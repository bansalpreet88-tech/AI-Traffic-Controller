...
Camera / Sensors capture traffic data

Processing Layer

Image processing / ML model analyzes traffic density

Decision Layer

AI algorithm decides signal timing

Output Layer

Traffic lights are controlled accordingly
...
│── src/                 # Source code
│── static/              # Images / UI files
│── templates/           # HTML (if Flask used)
